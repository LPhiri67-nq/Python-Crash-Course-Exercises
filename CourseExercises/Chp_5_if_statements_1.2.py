...
alien_colour = "green"
player_tag = input("Enter the name of your player tag. ")

# Write an "if statement" to test whether the alien’s color is green.
# If it is, print a message that the player just earned 5 points

if alien_colour == "green":
    print(f"\n{player_tag} just earned 5 points.")

# Write one version of this program...
# ...that passes the "if" test and another that fails.
...
if alien_colour == "green":
    ...
    print(f"\n{player_tag} just earned 10 points.")
...
if alien_colour == "green":
    ...
    print(f"\n{player_tag} just earned 15 points.")

# Write two other versions of this program,...
...
favourite_fruits = ["Tangerines", "Green Grapes", 
                    "Apples", "Pineapple", "Mangoes"]

if "Tangerines" in favourite_fruits:
    print("You really like tangerines!")
if "Green Grapes" in favourite_fruits:
    print("You really like Green Grapes!")
if "Red Grapes" in favourite_fruits:
    print("You really like Red Grapes!")
...
usernames = ["admin", "sarah", "chase", "jordan", "emily"]
...
print("Make sure to Log Out when you are finished.")
...
# Remove all the usernames from your list,...
# ...and make sure the correct message is printed.

usernames = ["admin", "sarah", "chase", "jordan", "emily"]

length_of_list = len(usernames)

if usernames:
    print(f"We have {length_of_list} users in the directory.")
else:
